<!-- UPDATED: Admin contract page with real-time Leadspedia contract status. -->
        ...
        <div class="card-body py-2 d-flex align-items-center">
          <div>
            ...
            <small class="text-muted">
              Advertiser: <?= html_escape($advertiser['name']) ?>
              <?php if (!empty($advertiser['company_name'])): ?> - <?= html_escape($advertiser['company_name']) ?><?php endif; ?>
              | Vertical: <?= html_escape(isset($vertical['vertical_name']) ? $vertical['vertical_name'] : '-') ?>
            </small>
          </div>
          <a href="<?= base_url('admin/mapping/' . (int) $advertiser['admin_id']) ?>" class="btn btn-success btn-sm ml-auto">
            <i class="fa fa-arrow-left"></i> Assigned Verticals
          </a>
        </div>
      </div>
            ...
            <div class="table-responsive">
              <table class="table table-bordered table-sm mb-3">
                <tbody>
                  ...
                  <tr><th>Advertiser Name</th><td><?= html_escape(!empty($contract['advertiser_name']) ? $contract['advertiser_name'] : '-') ?></td></tr>
                  <tr><th>Company Name</th><td><?= html_escape(!empty($contract['company_name']) ? $contract['company_name'] : '-') ?></td></tr>
            ...
            <div class="table-responsive">
              <table class="table table-bordered table-sm mb-0">
                <tbody>
                  ...
                  <tr><th>Local Advertiser ID</th><td><?= isset($contract['advertiser_id']) ? (int) $contract['advertiser_id'] : '-' ?></td></tr>
